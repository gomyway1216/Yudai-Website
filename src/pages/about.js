...
export default function contact({ data }) {
  return (
    <Layout>
      ...
      <div>
        I am aiming to be an engineer and participating in the projects that help people.
        I believe what I share in this blog could help somebody.
      </div>
      <br />
      ...
      <div>
        ...
        <section>
          ...
          <p>
            Building the Front-End of a tutor scheduling system for students with the feature for managers to control the service
          </p>
        </section>
        <section>
          <div>
          ...
          <p>
            Using React, Redux, Javascript, and TypeScript to develop a web platform that tracks companies online advertisement performances
            Researched machine learning models and tuned parameters to explore ways to improve the algorithm responsible for ad selection
            Created documents that explain Git, Bash, and coding syntax for other interns.
          </p>
        </section>
        <section>
          <div>
          ...
          <p>
            Completed an intensive course in HTML, CSS, JavaScript, TypeScript, Node.js, jQuery, react.js,　GraphQL, Prisma. Built a Weather app, twitter clone, and recipe sharing app
            Implemented a health app which detects and records patients’ movements in addition to providing them with health questionnaires having TTS & STT functionality
          </p>
        </section>
        <section>
          <div>
          ...
          <p>
            Set up computers, a phone system, and network systems and checked security for local Japanese companies
            Helped 3 Japanese companies expand to the U.S. by providing translations and local business and legal knowledge
            Made an Android Application to teach interns about company practice
          </p>
        </section>
      </div>
      ...
      <div>
        ...
        <section>
          <div>
              ...
              <span>UW-Madison Department of Materials Science and Engineering</span> 
              <span>Madison, WI</span>
          ...
          <a href={`https://skunkworks.engr.wisc.edu/`}>Link to UW-Madison Informatics Skunkworks</a>
        </section>
      </div>
      ...
      <div>
        ...
        <section>
          ...
          <p>
            Developing a dashboard that collects solar panel information and displays it throughout the university with fun metric
            Working on open sourcing the solar data for researchers and/or students to use as part of dashboard project
          </p>
        </section>
        <br />
        <section>
